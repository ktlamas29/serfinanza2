...
<section class="clsDiscountPr">
    <h3 class="title-section">
        Rompe los límites comprando en nuestros aliados con grandes descuentos:
    </h3>
    <div id="slideDiscountsProgress" class="grid-discounts slideDiscount">
        <?php if (false) { ?>
            ...
            <div class="item award discount shadow">
                ...
                <div class="content-image">
                    ...
                    <div class="logo" class="wow animated zoomIn">
                        <img src="/assets/descuentos/logo-mccenter.png" alt="">
                    </div>
                </div>
                ...
                <div class="description">
                    ...
                    <p class="desc">
                        ...
                        <a href="https://serfinanzatepremia.com/assets/descuentos/pdf/tyc-mccenter.pdf">Ver términos y condiciones.</a>
                    </p>
        ...
        <div class="item award discount shadow">
            ...
            <div class="content-image">
                ...
                <div class="logo" class="wow animated zoomIn">
                    <img src="/assets/descuentos/logo-presto.png" alt="">
                </div>
            </div>
        ...
        <?php if ($checkValidDiscount) { ?>
            ...
            <div class="item award discount shadow">
                ...
                <div class="content-image">
                    ...
                    <div class="logo" class="wow animated zoomIn">
                        <img src="/assets/descuentos/logo-go-rigo.png" alt="">
                    </div>
                </div>
        ...
        <div class="item award discount shadow">
            ...
            <div class="content-image">
                ...
                <div class="logo" class="wow animated zoomIn">
                    <img src="/assets/descuentos/logo-hbo.png" alt="">
                </div>
            </div>
        ...
        <div class="item award discount shadow">
            ...
            <div class="content-image">
                ...
                <div class="logo" class="wow animated zoomIn">
                    <img src="/assets/descuentos/logo-despegar.png" alt="">
                </div>
            </div>
        ...
        <div class="item award discount shadow">
            ...
            <div class="content-image">
                ...
                <div class="logo" class="wow animated zoomIn">
                    <img src="/assets/descuentos/logo-luxury.png" alt="">
                </div>
            </div>
    ...
    <div class="container cont-btn">
        <a href="/promociones" class="btn btn-main">Ver todas las promociones</a>
    </div>
</section>